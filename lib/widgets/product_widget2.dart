...
class ProductWidget2 extends StatefulWidget {
  ...
  @override
  State<ProductWidget2> createState() => _ProductWidgetState();
}

class _ProductWidgetState extends State<ProductWidget2> {
  ...
  _getProductImage() {
    ...
    return ClipRRect(
      ...
      child: SizedBox(
        width: defaultTargetPlatform == TargetPlatform.iOS ? 50 : 55,
        height: defaultTargetPlatform == TargetPlatform.iOS ? 50 : 55,
        child: widget.image_asset!.isEmpty
            ? Image.asset(
          ...
          fit: BoxFit.cover,
            ...
            : Image.network(
            fit: BoxFit.cover,
            "$RUE_IMAGE_BASE_PATH${widget.image_asset}"),
      ),
    );
  }
