...
@HiveType(typeId: APICategoryBoxTypeId)
class APICategory extends HiveObject {
  @HiveField(0)
  int id;
  ...
  factory APICategory.fromJson(String source) =>
      APICategory.fromMap(json.decode(source));
