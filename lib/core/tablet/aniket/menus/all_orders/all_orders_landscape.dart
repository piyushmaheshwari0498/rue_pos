...
class CurrentOrdersLandscape extends StatefulWidget {
  const CurrentOrdersLandscape({super.key});

  @override
  State<CurrentOrdersLandscape> createState() => _CurrentOrdersState();
// TODO: implement createState
}

class _CurrentOrdersState extends State<CurrentOrdersLandscape> {
        ...
        return SingleChildScrollView(
          ...
          child: Container(
            ...
            child: DataTable(
              ...
              headingRowHeight: 35,
              dataRowHeight: 100,
              dataTextStyle: getTextStyle(fontSize: LARGE_MINUS20_FONT_SIZE),
              headingTextStyle: getTextStyle(
                  fontWeight: FontWeight.bold,
                  fontSize: LARGE_MINUS20_FONT_SIZE,
                  color: WHITE_COLOR),
              ...
              rows: currOrders.orderList!
                  .map((element) => DataRow(
                        onSelectChanged: (selected) async {
                          if (selected!) {
                            if (Device.get().isTablet) {
                              ...
                              //   cash: element.netAmount!,
                              //   due: 0.0,
                              //   customerName: element.customer!, onOrderCancelled: () { getOrdersList(_currentSegment); },
                              // );
                        ...
                        cells: <DataCell>[
                          ...
                          DataCell(Container(
                            decoration: BoxDecoration(
                                color: element.deliveryType == 2 && element.status == 4 ? Colors.green.shade900 : Colors.orangeAccent,
                                borderRadius:
                                    BorderRadius.all(Radius.circular(10))),
                            padding: EdgeInsets.fromLTRB(15,5,15,5),
                            child: Text(
                              element.deliveryType == 2 && element.status == 4 ? "Closed" : ' ${element.statusText.toString()} ',
                              style: getTextStyle(
                                color: WHITE_COLOR,
