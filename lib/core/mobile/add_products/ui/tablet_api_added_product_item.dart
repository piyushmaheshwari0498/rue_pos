...
class TABAPiAddedProductItem extends StatefulWidget {
  Function? onDelete;
  Function? onItemAdd;
  Function? onItemRemove;
  APIOrderItem product;
  ...
  @override
  State<TABAPiAddedProductItem> createState() => _AddedProductItemState();
}

class _AddedProductItemState extends State<TABAPiAddedProductItem> {
