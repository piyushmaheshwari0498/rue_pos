...
import '../core/mobile/home/ui/home_dashboard.dart';
...
class Helper {
  ...
  static OrderDetailsModel? activeTableOrder;
  static List<OrderDtl>? activeOrderDtl;
  ...
  static void activateTableOrder(OrderDetailsModel parkedOrder) {
    activeTableOrder = parkedOrder;
  }
  ...
  // Future<bool> printInvoice(SaleOrder placedOrder) async {
    ...
    if (res == PosPrintResult.success) {
      final ByteData data = await rootBundle.load('assets/images/RueLogoDark.png');
